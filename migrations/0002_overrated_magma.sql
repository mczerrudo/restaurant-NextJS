...
ALTER TABLE `menu_items` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757991435;--> statement-breakpoint
...
ALTER TABLE `orders` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757991435;--> statement-breakpoint
ALTER TABLE `restaurants` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757991435;--> statement-breakpoint
ALTER TABLE `order_items` ADD `item_subtotal` real NOT NULL;