...
ALTER TABLE `menu_items` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757916185;--> statement-breakpoint
...
ALTER TABLE `orders` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757916185;--> statement-breakpoint
ALTER TABLE `restaurants` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1757916185;